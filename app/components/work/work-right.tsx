	...
	return (
		<div
			className={classNames(
				...
				'flex h-[70vh] flex-1 items-center justify-center lg:h-screen [--work-right-translate-multiplier:0] lg:[--work-right-translate-multiplier:1] [transform:translateY(calc(var(--work-right-translate-y)*var(--work-right-translate-multiplier)))]',
				outerClassName,
			)}
